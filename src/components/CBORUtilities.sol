...
library CBORUtilities {
    ...
    function parseField(bytes memory encoding, uint256 cursor)
        internal
        view
        returns (Spec.MajorType majorType, uint8 shortCount, uint256 start, uint256 end, uint256 next)
    {
     ...
     */
    function extractValue(bytes memory encoding, Spec.MajorType majorType, uint8 shortCount, uint256 start, uint256 end)
        internal
        pure
    ...
    function parseFieldEncoding(bytes1 fieldEncoding)
        internal
        pure
        returns (Spec.MajorType majorType, uint8 shortCount)
    {
